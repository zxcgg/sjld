...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`swing` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `city` (
  ...
  PRIMARY KEY (`cid`),
  KEY `FR_PID` (`pid`),
  CONSTRAINT `FR_PID` FOREIGN KEY (`pid`) REFERENCES `province` (`pid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `city` */

insert  into `city`(`cid`,`cname`,`pid`) values 
(1,'cxz',1),
(101,'123',1),
(102,'深圳市',1),
(103,'珠海市',1),
...
CREATE TABLE `t_address_city` (
  ...
  `provinceCode` varchar(6) NOT NULL COMMENT '所属省份编码',
  PRIMARY KEY (`id`)
...
CREATE TABLE `t_address_province` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=312 DEFAULT CHARSET=utf8 COMMENT='省份信息表';
...
CREATE TABLE `t_address_town` (
  ...
  `cityCode` varchar(6) NOT NULL COMMENT '所属城市编码',
  PRIMARY KEY (`id`)
...
insert  into `upload`(`path`,`pid`) values 
('loading.gif',129),
('loading-sm.gif',130),
('图片1.png',131);
